...
namespace MAIHealthCoach.Infrastructure.Migrations
{
    ...
    [Migration("20260625152810_AddPushReminders")]
    partial class AddPushReminders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAIHealthCoach.Domain.Notifications.DeviceRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DeviceRegistrations", "public");
                });

            modelBuilder.Entity("MAIHealthCoach.Domain.Notifications.ReminderPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MealReminderTimesJson")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.ToTable("ReminderPreferences", "public");
                });
            ...
            modelBuilder.Entity("MAIHealthCoach.Domain.Notifications.ReminderPreferences", b =>
                {
                    b.HasOne("MAIHealthCoach.Domain.Users.User", null)
                        .WithOne()
                        .HasForeignKey("MAIHealthCoach.Domain.Notifications.ReminderPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
